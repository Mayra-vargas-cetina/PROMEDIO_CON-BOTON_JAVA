...
public class interfaz_boton extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        promedio1s.setText(String.valueOf((double) Math.round(promedio1*100)/100)); //Se muestra en los labels el contenido de las variables y
                                                                                     //Se establece la cantidad de decimales a 2
        promedio2s.setText(String.valueOf((double) Math.round(promedio2*100)/100));
        promedio3s.setText(String.valueOf((double) Math.round(promedio3*100)/100));
        promedio4s.setText(String.valueOf((double) Math.round(promedio4*100)/100));
        promediofinals.setText("El promedio de las materias es: "+String.valueOf((double) Math.round(promedio_total*100)/100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfaz_boton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfaz_boton().setVisible(true);
            }
        });
    }
